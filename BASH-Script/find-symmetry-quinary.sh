...
ATOM4=`sed -n '6p' $1 | awk '{print $4}'`
ATOM5=`sed -n '6p' $1 | awk '{print $5}'`
ION1=`sed -n '7p' $1 | awk '{print $1}'`
ION2=`sed -n '7p' $1 | awk '{print $2}'`
ION3=`sed -n '7p' $1 | awk '{print $3}'`
ION4=`sed -n '7p' $1 | awk '{print $4}'`
ION5=`sed -n '7p' $1 | awk '{print $5}'`
Total_ions=`echo "$ION1+$ION2+$ION3+$ION4+$ION5" | bc`
...
sed -i '15 i '"$ION1*$ATOM1 $ION2*$ATOM2 $ION3*$ATOM3 $ION4*$ATOM4 $ION5*$ATOM5"'' $1-lattice_$k.in
